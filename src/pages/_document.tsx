...
export default function Document() {
  return (
    <Html lang="en">
      <Head>
        <meta charSet="utf-8" />
        <link href="/profilepic.jpg" rel="icon" type="image/jpeg" />
        <link href="/profilepic.jpg" rel="shortcut icon" type="image/jpeg" />
        <link href="/profilepic.jpg" rel="apple-touch-icon" />
