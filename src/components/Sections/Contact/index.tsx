...
const Contact: FC = memo(() => {
  ...
  return (
    <Section className="relative z-[2] bg-neutral-800 pb-8 md:pb-12" sectionId={SectionId.Contact}>
                    ...
                    <dd className="flex items-center">
                      <a
                        className={classNames(
                          '-m-2 flex rounded-md p-2 text-neutral-300 hover:text-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-400',
